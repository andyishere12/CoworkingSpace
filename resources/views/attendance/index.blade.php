...
<head>
  ...
  <style>
    ...
    .user-panel {
      ...
      margin-left: 10px;
      flex-shrink: 0;
      /* user-panel tidak ikut menyusut */
    }
    ...
    .nav-sidebar {
      ...
      overflow-y: auto;
      max-height: none;
      /* hapus batasan max-height sebelumnya */
    }
                  ...
                  <form method="GET" action="{{ route('attendance.index') }}">
                    <div class="row align-items-end">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="date" class="form-control border-0 bg-light" name="end_date"
                          value="{{ $endDate }}">
                      </div>
                      <div class="col-md-6 d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-success btn-print shadow-sm ml-auto mr-2"
                          onclick="cetakAttendance()">
