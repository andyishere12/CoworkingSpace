            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3">
                    <div class="image">
                        ...
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&size=80&background=6C3FB5&color=fff"
                                class="img-circle elevation-2" alt="Manager">
                        @endif
                    </div>
                    <div class="info">
                        <a href="{{ route('manager.profile.index') }}" class="d-block text-white font-weight-bold">
                            {{ auth()->user()->name }}
                        </a>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <!-- Members -->
                        <li class="nav-item">
                            <a href="{{ route('manager.members.index') }}"
                                class="nav-link {{ request()->routeIs('manager.members.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('manager.reservation-approval.index') }}"
                                class="nav-link {{ request()->routeIs('manager.reservation-approval.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('manager.settings') }}"
                                class="nav-link {{ request()->routeIs('manager.settings') ? 'active' : '' }}">
