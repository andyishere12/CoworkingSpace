                        ...
                        <div class="card-body">
                            <form action="{{ route('reservasi.store') }}" method="POST" id="reservasiForm">
                                ...
                                <div class="alert alert-info mb-3">
                                    ...
                                    Reservasi yang dibuat akan berstatus <strong>Pending</strong> dan menunggu
                                    persetujuan Manager.
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="nama_pemesanan">Nama Pemesanan <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('nama_pemesanan') is-invalid @enderror"
                                                id="nama_pemesanan" name="nama_pemesanan"
                                                value="{{ old('nama_pemesanan') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                class="form-control @error('attends') is-invalid @enderror" id="attends"
                                                name="attends" min="1" value="{{ old('attends', 1) }}" required>
                                            @error('attends')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="waktu_mulai">Start Time <span
                                                    class="text-danger">*</span></label>
                                            <input type="time"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="waktu_selesai">End Time <span
                                                    class="text-danger">*</span></label>
                                            <input type="time"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control" style="background:#f8f9fa; cursor:default;">
                                                <span class="badge badge-warning px-2 py-1">
                                                    <i class="fas fa-clock mr-1"></i>Pending (Menunggu Persetujuan
                                                    Manager)
                                                </span>
                                            </div>
