...
<head>
    ...
    <title>Edit Room - Trackingspace</title>
    <link rel="stylesheet"
    ...
    <style>
        /* Sidebar custom dari index (sama dengan create) */
        body {
        ...
        /* Style notifikasi (dipertahankan dari edit.asli) */
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="p-3">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                {{-- FORM EDIT (dipertahankan utuh dari edit.asli) --}}
                                <form action="{{ route('room.update', $room->id) }}" method="POST" id="roomForm">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select 
                                                    ...
                                                    name="type" 
                                                    required>
                                                    <option value="" disabled {{ old('type', $room->type) ? '' : 'selected' }}>Pilih Tipe Room</option>
                                                    <option value="Indoor" {{ old('type', $room->type) == 'Indoor' ? 'selected' : '' }}>Indoor</option>
                                                    <option value="Outdoor" {{ old('type', $room->type) == 'Outdoor' ? 'selected' : '' }}>Outdoor</option>
                                                    <option value="Semi Outdoor" {{ old('type', $room->type) == 'Semi Outdoor' ? 'selected' : '' }}>Semi Outdoor</option>
                                                </select>
                                                @error('type')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
    ...
    {{-- Notification Container & Script (dipertahankan dari edit.asli) --}}
    ...
    <script>
        // Fungsi notifikasi (dipertahankan dari edit.asli)
